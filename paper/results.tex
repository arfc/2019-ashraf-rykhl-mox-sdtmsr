...
fissile materials and production of poisonous fission products \gls{FPs}. Thus, the 
...
however, the total volume of fuel salt in the core remains constant because it
is bounded by the vessel. When the graphite temperature increases, the density 
of graphite decreases, creating additional space for the salt. The 
cross-section temperatures for the fuel and moderator were changed from 900 to 
1000 K to determine the temperature coefficients. This work considers five 
different cases:
\begin{enumerate}
...
online reprocessing capabilities, all six factors are calculated at the 
...
$p$ decreases during reactor operation. The thermal fission factor ($\eta$)  
