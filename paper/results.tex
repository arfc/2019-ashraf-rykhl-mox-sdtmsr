...
\gls{SD-TMSR} for a 60 year lifetime (Figure~\ref{fig:keff1} (U-233 case)). 
...
$^{233}$U. 
To avoid the nuclear weapons proliferation, we recommended stopping the SD-TMSR after producing the required $^{233}$U ($\approx$ $4.5$) and replacing the core fuel by Th/$^{233}$U fuel.
