...
more. Consequently, the initial $k_{eff}$ for these cases increased (Figure~\ref{fig:keff1} (HALEU and reactor-grade Pu cases)). But the produced $^{233}$U is insufficient to keep the reactor critical and counteract parasitic neutron absorption. Therefore, $k_{eff}$ is decreased below 1.0, after $\approx$ $6$ years in the HALEU case and $\approx$ $12$ years in the reactor-grade Pu case.
