...
fissile $^{233}$U inventory to start-up new \glspl{MSR}. But $^{233}$U does not
...
materials (e.g., $^{235}$U) to replace the $^{233}$U in the start-up fuel
...
time\footnote{Time required to produce enough amount of $^{233}$U to trigger a
	new SD-TMSR.} of $^{233}$U because in this case all start-up fissile material
is being substituted by newly produced $^{233}$U.

Betzler \emph{et al.} discussed the simulation of the start-up of a MSBR unit
...
as start-up fuel. They concluded that the transition to thorium fuel cycle can
