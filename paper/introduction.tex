...
\begin{itemize}
	...
	\item Non-thorium feed mechanism: continuous injection of Heavy Metal (HM) (excluding Th) and simultaneously feed of all or fraction of $^{233}$U from \texttt{Pa-decay tank}.
\end{itemize}
