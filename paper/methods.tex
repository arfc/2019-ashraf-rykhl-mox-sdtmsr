...
the fuel salt, graphite elements, reflector, shielding, \gls{IHX} and made of Ni-based (hastelloy N) alloy. The main 
...
fissile materials based on \gls{LEU}, Pu, and \gls{TRU} from LWR SNF were 
considered:
\begin{enumerate}[label=(\alph*)]
	\item low-enriched uranium (LEU) (19.79\%);
	\item Pu mixed with \gls{LEU} (19.79\%);
	\item Pu reactor-grade \cite{marka1993explosive};
	\item transuranic (TRU) elements from LWR SNF \cite{de2000scenarios};
...
average discharge burnup $33$ $GWd/tHM$ and after $10$ years of cooling before 
reprocessing \cite{oecd1989probabilistic,marka1993explosive}. Similarly, the 
isotopic compositions of \gls{TRU} was taken for the SNF of UOX \gls{PWR} 
...
\begin{enumerate}
	...
	\item A simple calculation yields the amount of \gls{HM} that must be added during this cycle:
	...
	\subitem 3b. For non-thorium feed mechanism: mass of \gls{HM} (excluding Th) $\approx$ mass of extracted FPs and mass of $^{233}$U $\approx$ mass of extracted Pa.
...
The first mechanism allows continuous feed flow of thorium from Th stockpile, and 
...
the gaseous \gls{FPs} and non-dissolved metals was set to 30s (removal 
